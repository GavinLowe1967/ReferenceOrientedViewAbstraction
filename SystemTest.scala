...
object SystemTest{
  ...
  private def consistentStatesTest(system: System) = {
    def test1 = {
      ...
      val buff = system.consistentStates((0,N2), conc, -1, cv1)
    ...
    def test2 = {
      ...
      val conc = 
        new Concretization(servers1, Array(aNode(N0,N1), aNode(N1,Null)))
      val cv1 = new ComponentView(servers1, pushSt(T0,N0), Array(aNode(N0,N1)))
      val buff = system.consistentStates((0,N1), conc, -1, cv1)
    ...
    def test5 = {
      ...
      // control states.
      val buff1 = system.consistentStates((0,N0), conc, -1, cv1)
      assert(buff1.isEmpty)
      // Neither node of cv1 can be renamed to N1
      val buff2 = system.consistentStates((0,N1), conc, -1, cv1)
      ...
      val buff3 = system.consistentStates((0,N2), conc, -1, cv1)
    ...
    def test6 = {
      ...
      val buff1 = system.consistentStates((0,N2), conc, -1, cv1)
      ...
      val buff3 = system.consistentStates((0,N0), conc, -1, cv1)
    ...
    def test8 = {
      ...
      val buff2 = system.consistentStates((0,N0), conc, -1, cv1)
      assert(buff2.isEmpty)
    }
    ...
    def test9 = {
      ...
      val buff = system.consistentStates((0,N2), conc, e, cv1)
